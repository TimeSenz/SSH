...
<div class="wrap">
  ...
  <div class="main">
    ...
    <div class="article">
     ...
     <s:elseif test="%{#userlist==''}">
		<tr><td style="border:none;border: none;position: absolute;left: 50%;font-size: 25px;top: 230px;color:#555">暂无数据</td></tr>
   </s:elseif>
                           <s:iterator value="userlist" var="vo">
                           <tr>
                           <td><s:property value="#vo.userid"/></td>  
                           <td ><span class="span" style="width:320px;"><s:property value="#vo.name"/></span></td> 
                             <td><s:property value="#vo.sex"/></td> 
                              <td><s:property value="#vo.remark"/></td> 
                           <td><s:property value="#vo.address"/></td> 
                      
                           <td><input type="checkbox" name="phone" id="checkBox" value="<s:property value="#vo.phone"/>" /></td>
