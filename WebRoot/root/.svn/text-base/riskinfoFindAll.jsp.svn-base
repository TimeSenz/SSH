...
<html>
  ...
  <div class="main">
      ...
      <div class="aside_main">
        <ul>
          ...
          <ol class="ol2">
                ...
                <li class="cur"><a href="riskinfo/findAll.action">风控</a></li>
   ...
   <s:iterator value="riskinfolist" var="vo">
   <tr>
  ...
  <td> <s:property value="#vo.name"/></td> 
   ...
   <td><s:a href="riskinfo/findById.action?id=%{#vo.id}" cssClass="title2"></s:a></td>
   <td><s:a href="riskinfo/deleteRiskinfo.action?id=%{#vo.id}" onClick="{if(confirm('确实要删除吗？')){return true;}return false;}">删除</s:a></td>
    </tr>
   </s:iterator>
   </table>
  </s:form>
