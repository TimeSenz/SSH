...
<html>
  ...
  <script  type="text/javascript">
   function add(){
         ...
         document.forms[0].action="<%=path%>/root/addCusinfo.jsp";
      ...
      <div class="aside_main">
        <ul>
          ...
          <ol class="ol2">
                ...
                <li class="cur"><a href="cusinfo/findAll.action">客服</a></li>
  ...
  <s:iterator value="cusinfolist" var="vo">
  <tr>
  ...
  <td><s:a href="cusinfo/findById.action?id=%{#vo.id}" cssClass="title2"></s:a></td>
  <td><s:a href="cusinfo/deleteCusinfo.action?id=%{#vo.id}" onClick="{if(confirm('确实要删除吗？')){return true;}return false;}" cssClass="title4">删除</s:a></td>
  </tr>
  </s:iterator>
  </table>
  </s:form>
