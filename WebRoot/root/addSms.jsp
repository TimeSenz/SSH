    ...
    <div class="article">
            ...
            <div class="mod_table">
                ...
                <div class="mod_table_main">
                    ...
                    <s:form action="/sms/addSms.action">
                          <input type="hidden" id="cusinfo" name="cusinfo" value="<s:property value="#session.cusinfo.name"/>"/>
                           <ul  class="mod_table_main_ul">
                           <li><strong>Cid：</strong><input type="text" name="sms.cid"  autocomplete="off"></span></li>
                           <li><strong>标题：</strong><input type="text" name="sms.remark"  autocomplete="off"></span></li>
                           <li><strong>内容：</strong><input type="text" name="sms.contents"  autocomplete="off"></span></li>
                           <li><strong>传参个数：</strong><input type="text" name="sms.pronum"  autocomplete="off"></span></li>
