  ...
  <div class="main">
      ...
      <div class="aside_main">
         <ul>
          ...
          <li class="cur"><strong class="icon11"><span><a href="/ZhongCaiBao/newsinfo/findAllByDong.action?currentPage=1">新闻动态</a></span></strong></li>
          ...
          <li><strong class="icon11"><span><a href="/ZhongCaiBao/sms/findAll.action?currentPage=1">短信模版</a></span></strong></li>
   	      ...
   	      <ol class="ol2" style="display:none">
                <li class="cur"><span><a href="/ZhongCaiBao/userinfo/findAll.action?currentPage=1">所有用户</a></span></li>
    ...
    <div class="article">
     ...
     <s:elseif test="%{#donglist==''}">
		<tr><td style="border:none;border: none;position: absolute;left: 50%;font-size: 25px;top: 230px;color:#555">暂无数据</td></tr>
                           ...
                           <td title="预览"><s:a href="newsinfo/findoneById.action?id=%{#vo.id}" cssClass="title5"></s:a></td>
                           <td title="修改"><s:a href="newsinfo/findById.action?id=%{#vo.id}" cssClass="title2"></s:a></td>
