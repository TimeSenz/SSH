  ...
  <div class="main">
      ...
      <div class="aside_main">
         <ul>
          ...
          <li class="cur"><strong class="icon11"><span><a href="/ZhongCaiBao/newsinfo/findAllByMei.action?currentPage=1">媒体报道</a></span></strong></li>
