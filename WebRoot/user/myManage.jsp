...
<!--头部end-->
<div class="fund_main"> 
            <p class="top_title"><span><a href="/ZhongCaiBao">首页</a></span>&nbsp;&gt;&nbsp;我的理财&nbsp;&gt;&nbsp;我的债权 </p> 
...
<!--         <li class="six"><a href="/ZhongCaiBao/user/financial.jsp"><span><strong>理财劵</strong></span></a></li> 
     ...
     <!--我的理财-债券start-->
      <div class="fund_main3">
        <div class="fund_main3_right1">
              ...
              <dl>
              <dt>已赚金额</dt>
                      <dt style="color:#d45757;margin-bottom: 15px;"><i class="jine"><big style="font-size: 28px;"><s:property value="#session.userinfo.choicePromoney+#session.userinfo.bulkPromoney"/></big></i>元</dt>
                      <dd>利息收益   <i class="jine"><big><s:property value="#session.userinfo.choicePromoney+#session.userinfo.bulkPromoney"/></big></i>元 </dd>
                    ...
                    <dl style="border:none;width:480px;">
                      ...
                      <ul>
                        ...
                        <li style="width:200px;"><span>交易金额 <br><i class="jine"><b><s:property value="#session.person_profit_bulk.Finance_accounts+#session.person_profit_choice.Finance_accounts"/></b></i>元</span></li>
                      </ul></dd>
                      <!-- <dd>   <ul>
   ...
   <input type="hidden" id="totalPage" name="totalPage" value='<%=totalPage %>' />
      <input type="hidden" id="user" name="user" value="myManage" />
                       <table cellspacing="0"> 
                      <colgroup>
                      ...
                      <tbody> 
                    <s:iterator value="wdzqlist" var="vo">
                       <tr>  	
                        ...
                        <td><span class="width100white jine"><big><s:property value="#vo.earnmoney"/></big></span></td> 
                        <td><span><b>
                      
                         <s:if test="#vo.bidtype==信">
                         <s:property value="#vo.joinmoney/1000"/>
                        </s:if>
                        <s:else>
                        <s:property value="#vo.joinmoney/50"/>
                        </s:else>
                        
                        </b></span></td> 
                        <td><span class="width100white"><s:date name="#vo.buytime" format="yyyy-MM-dd" /></span></td> 
                        <td ><s:property value="#vo.state"/></td> 
                        <td><a target="_blank" href="/ZhongCaiBao/bidinfo/creatxieyi.action?bidid=<s:property value="#vo.bidid" />&userid=<s:property value="#session.userinfo.userid"/>">借款协议</a></td> 
                       </tr> 
                       </s:iterator>
                      <!--  
                       <tr> 
         ...
         function findByPage(pp){
          ...
          function alastPage(){
            ...
            <div class="right bottom">
                <h3>我的债权</h3>
                <p>通过众财宝平台产生的交易均会产生债权，我的债权里包括全部的债权。</p>
            </div>
          </div>
      </div>
     <!--我的理财-债券end--> 
