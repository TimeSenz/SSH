...
<!--头部end-->
<div class="fund_main"> 
            <p class="top_title"><span><a href="/ZhongCaiBao">首页</a></span>&nbsp;&gt;&nbsp;我的理财&nbsp;&gt;&nbsp;投资散标 </p> 
	...
	<div class="left"> 
      <div class="top"> 
       <ul> 
        ...
        <li class="three"><a href="/ZhongCaiBao/userinfo/user.action?user=myManage"><span class="cur"><strong class="cur1">我的理财</strong></span></a>
          <ol> 
          <li><a href="/ZhongCaiBao/userinfo/user.action?user=myManage">我的债权<i>（协议）</i></a></li> 
          <li><a href="/ZhongCaiBao/userinfo/user.action?user=myJxlc">精选理财</a></li> 
          <li class="cur"><a href="/ZhongCaiBao/userinfo/user.action?user=myTzsb">投资散标</a></li>
...
<!--         <li class="six"><a href="/ZhongCaiBao/user/financial.jsp"><span><strong>理财劵</strong></span></a></li> 
      ...
      <div class="fund_main3">
        <div class="fund_main3_right1">
            <div class="right top">
              <dl>
              <dt>投资散标已赚金额</dt>
                      <dt style="color:#d45757;margin-bottom: 15px;"><i class="jine"><big style="font-size: 28px;"><s:property value="#session.userinfo.bulkPromoney"/></big></i>元</dt>
                      <dd>利息收益    <i class="jine"><big><s:property value="#session.userinfo.bulkPromoney"/></big></i>元 </dd>
                    ...
                    <dl style="border:none;width:480px;">
                      ...
                      <ul>
                        ...
                        <li style="width:200px;"><span>持有中的数量 <br><i><b><s:property value="#session.person_profit_bulk.Finance_accounts/50"/></b></i>个</span></li>
                      </ul></dd>
                      <!-- <dd>   <ul>
   ...
   <input type="hidden" id="totalPage" name="totalPage" value='<%=totalPage %>' />
      <input type="hidden" id="user" name="user" value="myTzsb" />
                     <table cellspacing="0"> 
                      <colgroup>
                      ...
                      <tbody> 
                      <s:iterator value="tzsblist" var="vo">
                       <tr> 
                        <td><span class="width100white"><s:property value="#vo.bidname"/></span></td> 
                        <td><span class="width100white"><b><s:property value="#vo.joinmoney"/></b>(<b><s:property value="#vo.joinmoney/50"/></b>份)</span></td> 
                        <td><s:property value="#vo.profit"/> </td> 
                        <td><span class="width100white"><big><s:property value="#vo.earnmoney"/></big></span></td> 
                        <td><span><b><s:property value="#vo.joinmoney/50"/></b></span></td> 
