...
<!--main开始-->
    <div class="login-main-container">
        <div class="w1000">
        	<div class="btn_box">
				<a href="/ZhongCaiBao/user/getPwd.jsp" class="btn fleft cur">使用邮箱找回密码</a>
        <a href="/ZhongCaiBao/user/getPwds.jsp" class="btn fleft">使用手机号找回密码</a>
        	</div>
        	<div class="line">
	        	<span class="bottom b1"></span>
	        	<span class="bottom b2" style="display:none"></span>
        	</div>
        	<div class="con_box clear">
        		<div class="con">
        	<form action=""method="post" autocomplete="off" onSubmit="return check6();">
                      <div class="ui-form-item">
                        <label class="ui-label"><span >*</span>邮箱地址</label>
                        <input type="text" placeholder="请输入绑定邮箱地址" id="email" >
                        <span id="tips">
