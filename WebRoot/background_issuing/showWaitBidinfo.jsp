...
<html>
  ...
  <div class="main">
    <div class="aside">
      ...
      <ul>
          ...
          <li  class="cur"><strong class="icon4"><span><a href="/ZhongCaiBao/bidinfo/findByState.action?a=2&&currentPage=1" >待上标</a></span></strong></li>
 ...
 <input type="hidden" id="currentPage" name="currentPage" value='<%=currentPage %>' />
  ...
  <td> <s:if test="#session.riskinfo.bidper==1">
