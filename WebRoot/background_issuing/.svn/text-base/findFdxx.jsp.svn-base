    ...
    <div class="article">
      ...
      <div id="mod_table">
        <div class="mod_table">
          ...
          <div class="mod_h3"> <a href="Excel/housingLoan.xls"> 房贷信息下载</a></div>
        <s:form>
...
<input type="hidden" id="areaPage" name="areaPage" value='<%=areaPage %>' />
 ...
 <table id="table_test">
   ...
   <td><s:property value="#vo.fwmj"/> </td> 
   <td><s:property value="#vo.fwszcs"/></td> 
   <td><s:property value="#vo.fl"/></td>
    <td><s:property value="#vo.dkjg"/> </td> 
   <td><s:property value="#vo.ydje"/></td> 
   <td><s:property value="#vo.syje"/></td> 
