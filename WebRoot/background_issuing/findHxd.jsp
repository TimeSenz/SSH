         ...
         <s:if test="#session.riskinfo.bidper==1">
          <li ><strong class="icon10"><span><a href="/ZhongCaiBao/bidinfo/findAllFinanceplan.action">精选理财计划</a></span></strong></li>
            ...
            <ol class="ol2" style="display:block">
                ...
                <li class="cur"><span><a href="/ZhongCaiBao/riskinfo/findHxd.action?currentPage=1">汇信贷</a></span></li>
              </ol>
        </ul>
      </div>
    </div>
    <div class="article">
      ...
      <div id="mod_table">
        <div class="mod_table">
          ...
          <div class="mod_h3"> <a href="Excel/creditLoan.xls"> 信贷信息下载</a></div>
    <s:form>
...
<input type="hidden" id="areaPage" name="areaPage" value='<%=areaPage %>' />
 ...
 <table id="table_test">
   ...
   <td><s:property value="#vo.szcs"/> </td> 
   <td><s:property value="#vo.gsmc"/></td> 
   <td><s:property value="#vo.zw"/></td>
    <td><s:property value="#vo.ysr"/> </td> 
   <td><s:property value="#vo.dkje"/></td> 
   <td><s:property value="#vo.dkqx"/></td> 
