...
<!--main开始-->
    <div class="main_box">
        <div class="w1000">
            <!--顶部标题-->
            <p class="top_title"><span><a href="/ZhongCaiBao">首页</a></span>&nbsp;&gt;&nbsp;<a href="/ZhongCaiBao/about/about.action?flag=com">关于我们</a>&nbsp;&gt;&nbsp;新闻公告</p>
            <div class="con fn_clear">
                ...
                <div class="tab_btn_con fleft">
                    ...
                    <a href="/ZhongCaiBao/newsinfo/findByGong.action?currentPage=1" class="rrd-dimgray btn cur">新闻公告</a>
                  ...
                  <s:form  name="f2" >
                    ...
                    <input type="hidden"  id="areaPage" name="areaPage" value='<%=areaPage%>'/>
                     ...
                     <ul class="ui-list-news">
                        <s:iterator value="moregonglist" var="vo">
