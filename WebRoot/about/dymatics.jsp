...
<!--main开始-->
    <div class="main_box">
        <div class="w1000">
            <!--顶部标题-->
            <p class="top_title"><span><a href="/ZhongCaiBao">首页</a></span>&nbsp;&gt;&nbsp;<a href="/ZhongCaiBao/about/about.action?flag=com">关于我们</a>&nbsp;&gt;&nbsp;<a href="/ZhongCaiBao/newsinfo/findByDong.action?currentPage=1">最新动态</a></p>
            <div class="con fn_clear">
               <!--左侧Tab-->
                ...
                <div class="right_con fleft">
                 ...
                 <s:iterator value="moredonglist" var="vo">
                    <!--  <tr>
                    ...
                    <td><s:date name="#vo.time" format="yyyy-MM-dd" /></td> 
                        ...
                        <li class="ui-list-item fn_clear">
                                ...
                                <p class="fleft text">
                                    <s:a class="text-big rrd-dimgray" target="_blank" href="newsinfo/findOneById.action?id=%{#vo.id}"><s:property value="#vo.title"/></s:a>
