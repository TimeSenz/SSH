...
<!--main开始-->
    <div class="main_box">
        <div class="w1000">
            <!--顶部标题-->
            <p class="top_title"><span><a href="/ZhongCaiBao">首页</a></span>&nbsp;&gt;&nbsp;<a href="/ZhongCaiBao/about/about.action?flag=com">关于我们</a>&nbsp;&gt;&nbsp;还款公告</p>
            <div class="con fn_clear">
               <!--左侧Tab-->
                <div class="tab_btn_con fleft">
                    ...
                    <a href="/ZhongCaiBao/newsinfo/findByHuan.action?currentPage=1" class="rrd-dimgray btn cur">还款公告</a>
                ...
                <div class="right_con fleft">
                 ...
                 <s:iterator value="morehuanlist" var="vo">
                    <!--  <tr>
                    ...
                    <td><s:date name="#vo.time" format="yyyy-MM-dd" /></td> 
                        ...
                        <li class="ui-list-item fn_clear">
                                ...
                                <p class="fleft text">
                                    <s:a class="text-big rrd-dimgray" href="newsinfo/findOneById.action?id=%{#vo.id}" target="_blank"><s:property value="#vo.title"/></s:a>
