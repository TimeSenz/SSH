...
<!--头部-->
  <%@include file="../pub/pub_top.jsp" %> 
   <div class="recharg">
    ...
    <p><a href="">已完成付款</a><a href="">付款遇到问题</a></p>
  </div>
<!--头部end-->
<div class="fund_main"> 
    <h3 class="fund_h3"> <span>首页 〉资金管理 〉</span>充值</h3> 
     ...
     <div class="right right_2"> 
        <div class="fund_main2"> 
         ...
         <div class="right_2_form"> 
          <h3>充值金额</h3>
             <s:form name="payForm" id="payForm" onsubmit="return showTime()" target="_blank" >
          <ol> 
           <li><strong>充值金额：</strong><input type="text" name="money"  id="money"/> 元</li> 
           <input type="hidden" id="userid" name="userid" value="<s:property value="#session.userinfo.userid"/>"/> 
            <input type="hidden" id="username" name="username"  value="<s:property value="#session.userinfo.name"/>"/> 
           <input type="hidden" id="requestId" name="requestId"/> 
           
           <li><strong>充值费用 ：</strong><span><i>0.00</i>元</span> <a href="">第三方收取</a></li> 
           <li><strong>实际支付金额 ：</strong><span><i>0.00</i>元</span></li> 
           <li><input type="submit" Class="right_2_button" id="right_2_button" onclick="showTime()" value="确认支付"></li> 
          </ol>
          </s:form> 
         </div>
