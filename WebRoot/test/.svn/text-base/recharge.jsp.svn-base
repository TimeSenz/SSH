     ...
     <div class="right right_2"> 
        <div class="fund_main2"> 
         ...
         <div class="right_2_form"> 
          <h3>充值金额</h3>
          <form action="<%=path %>/userinfo/recharge.action"> 
          <ol> 
           <li><strong>充值金额 ：</strong><input type="text" name="money" /> 元</li> 
           <li><strong>充值费用 ：</strong><span><i>0.00</i>元</span> <a href="">第三方收取</a></li> 
           <li><strong>实际支付金额 ：</strong><span><i>0.00</i>元</span></li> 
           <li><s:submit cssClass="right_2_button" value="确认支付"></s:submit></li> 
          </ol>
          </form> 
         </div>
