        ...
        <ul>
          <div>
              ...
              <ol class="ol1">
                ...
                <li class="cur"><a href="/ZhongCaiBao/financeact/financeActjn.action?currentPage=1">放款未批准</a></li>
  ...
  <%
    ...
    <a href="javascript:nnextPage()">下一页</a>
      ...
      <script type="text/javascript">
         function nnextPage(){
       	  if(parseInt( document.getElementById("c").value)<parseInt( document.getElementById("total").value)){
             ...
             f3.submit();
        	  ...
        	  else if(parseInt( document.getElementById("c").value)==parseInt( document.getElementById("total").value)){
        		  alert("当前已经是最后一页");
        	  }
         }
          ...
          function nlastPage(){
        	  if(parseInt( document.getElementById("c").value)>1){
                 ...
                 f3.submit();
             	  ...
             	  else if(parseInt( document.getElementById("c").value)==1){
             		  alert("当前已经是第一页");
             	  }
         }
