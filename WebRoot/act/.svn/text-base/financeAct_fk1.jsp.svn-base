 ...
 <td><s:a href="bidinfo/findById.action?id=%{#vo.id}">开始出借</s:a></td> -->
   ...
   <div class="pagination Pagination1">
    <a href="javascript:lastPage()">上一页</a>
      ...
      function nextPage(){
    	  if(parseInt( document.getElementById("cu").value)<parseInt( document.getElementById("total").value)){
         ...
         f4.submit();
    	  ...
    	  else if(parseInt( document.getElementById("cu").value)==parseInt( document.getElementById("total").value)){
    		  alert("当前已经是最后一页");
    	  }
      }
         function findByPage(pp){
          ...
          function lastPage(){
        	  if(parseInt( document.getElementById("cu").value)>1){
             document.getElementById("cu").value= parseInt(document.getElementById("cu").value)-1;  
            ...
            f4.submit();
        	  ...
        	  else if(parseInt( document.getElementById("cu").value)==1){
        		  alert("当前已经是第一页");
        	  }
          }
