...
<div class="wrap">
  ...
  <s:form name="f2">
   ...
   <td><big><s:property value="#vo.zcrje"/></big></td> 
   ...
   <td><s:date name="#vo.time" format="yyyy-MM-dd HH:mm:ss" /></td>
    ...
    <td style="width:150px;"> <a href="rootact/changeJkract.action?finance=1&flag=2&id=${vo.id}" class="a5d6">批准</a>
        <a href="rootact/changeJkract.action?flag=0&id=${vo.id}" class="a5d6">不批准</a>
   </td>
  </s:if>
  <s:else>
  <td></td>
