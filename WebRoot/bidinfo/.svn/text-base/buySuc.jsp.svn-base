...
<html>
  <head>
    ...
    var i = 4;
            ...
            if(i == 0) {
                    location.href = "/ZhongCaiBao/userinfo/user.action?user=myZCB";
                }
  ...
  <body>
    ...
    <div class="main_box main_bg">
        ...
        <div><span id="time">5</span>秒后自动跳转至我的众财宝，或<a href="/ZhongCaiBao/userinfo/user.action?user=myZCB">直接跳转</a></div>
        <meta http-equiv="refresh" content="5;URL=<%=basePath%>/bidinfo/bidSuccessJump.action"/>
        </div>
    </div>
    </div>
    <!--main结束-->
